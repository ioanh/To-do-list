...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    var TodoService = /*#__PURE__*/function () {
      ...
      _createClass(TodoService, [{
        ...
        value: function getTodos() {
          return this.http.get("".concat(this.todosUlr).concat(this.todosLimit));
        } //Delete Todo

      }, {
        key: "deleteTodo",
        value: function deleteTodo(todo) {
          var url = "".concat(this.todosUlr, "/").concat(todo.id);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\1234\Desktop\Websites\angular-crash-todolist\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
